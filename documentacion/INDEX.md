...
| [ISS-012](./ISS-012_ai-renderer.md) | AI Renderer (fondos generados por Gemini Imagen) | `completado` | Media |
| [ISS-013](./ISS-013_ui-tab-visual.md) | UI Pestaña 3 — VISUAL (generador de carruseles) | `completado` | Alta |
...
| [ISS-017](./ISS-017_ui-tab-biblioteca.md) | UI Pestaña 5 — BIBLIOTECA (gestión de proyectos) | `completado` | Media |
